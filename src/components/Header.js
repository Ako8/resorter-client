    ...
    return (
        <section>
            <Card className="bg-dark text-white" style={{ borderRadius: '0', position: 'relative' }}>
                {isBigScreen && <Card.Img style={{ maxHeight: '350px', objectFit: 'cover' }} src="https://www.thetimes.co.uk/travel/wp-content/uploads/sites/6/2022/09/HERO_Panoramic-view-of-the-old-town-of-Tbilisi-Georgia_Credit_GettyImages-1012486898.jpg" alt="Card image" />}
                ...
                <Card.ImgOverlay>
                    <Container>
                        ...
                        {isBigScreen && <Card.Title><span style={{ fontSize: "30px",  }}>Resorter.ge</span></Card.Title>}
